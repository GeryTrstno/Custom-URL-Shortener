...
export default function Login({
    ...
    return (
        <div className="flex min-h-screen items-center justify-center bg-gray-900 px-4 py-12 sm:px-6 lg:px-8 selection:bg-violet-500 selection:text-white relative overflow-hidden">
            <Head title="Log in" />
